...
var Engine = (function(global) {
    ...
    function main() {
        ...
        if ((Date.now() - lastTimeCreate) / 1000.0 > 1.5) {
            var e = new Enemy();
            var e1 = new Enemy('images/enemy-bug.png',-1,parseInt(Math.random() * 6) + 1,parseInt(Math.random() * 2) + 1 * 400);
            var e2 = new Enemy('images/enemy-bug.png',-1,parseInt(Math.random() * 6) + 1,parseInt(Math.random() * 2) + 1 * 300);
            var e3 = new Enemy('images/enemy-bug.png',-1,parseInt(Math.random() * 6) + 1,parseInt(Math.random() * 2) + 1 * 200);
            var e4 = new Enemy('images/enemy-bug.png',-1,parseInt(Math.random() * 6) + 1,parseInt(Math.random() * 2) + 1 * 500);
